...
/*
  >>> test-exn: -1 @ std::string "error message"
  >>> test-exn: -500.55 @ std::string "error message"
  >>> test: 0 @ 1
  >>> test: 1 @ 1
  >>> test: 2 @ 2
  >>> test: 3 @ 6
...
// >>> test-exn: -5 @ std::string "error"
// >>> test-exn: -1000 @ std::string "error"
// >>> test: 0 @ 0
// >>> test: 1 @ 1
// >>> test: 2 @ 1
// >>> test: 3 @ 2
...
// >>> test-input: some_obj.x some_obj.y @ (some_obj = Obj()) (some_obj.x = 5) (some_obj.y = 1) @ 6 2
void mutate(Obj &some_obj){
  some_obj.x++;
  some_obj.y++;
}
